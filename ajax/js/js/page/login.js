...
<div class="logo">
    <img src="http://localhost/Gradesign/img/logo1.jpg"/>
</div>
<form id="js_login_btn">
    ...
    <p class="bg-success bg-register" id="js_bgRegister">没有有账号,去注册</p>
...
Login.prototype = {
    ...
    handleSubmitCb(e){
        ...
        axios({
            method:"post",
            url:"http://localhost/Gradesign/ajax/php/login.php",
            data:{
    ...
    handleLoginSuccess(data){
        if(data.status){
            location.href="http://localhost/Gradesign/index.html";
        }
    },
    handleTo(){
